                 ...
                 <form what="settings_main" method="post">
                    <section>
                        <item>
                            ...
                            <input type="text" name="name" value="<?php echo ($dynamic['name'] !== "n") ? $dynamic['name'] : "" ; ?>" maxlength="30" data-rule-valid='[{"key":"regexp","value":"^[а-яА-ЯёЁa-zA-Z]{3,30}$"}]'>
                        </item>
                        <item>
                            <label for="surname"><?php echo $static['content']['SURNAME']; ?>:</label>
                            <input type="text" name="surname" value="<?php echo ($dynamic['surname'] !== "n") ? $dynamic['surname'] : "" ; ?>" maxlength="30" data-rule-valid='[{"key":"regexp","value":"^[а-яА-ЯёЁa-zA-Z]{3,30}$"}]'>
                        </item>
                  ...
                  <section>
                       <item>
                        ...
                        <item>
                            ...
                            <label class="checkbox"> <input type="checkbox" name="mailing" <?php echo ($dynamic['mailing'] !== "n") ? "checked"  : "" ; ?> ><?php echo $static['content']['MAILING']; ?></label>
                        </item>
...
/************Menu show***********************/ 
    ...
    function menuShow(){
        $('ul .profile-settings').addClass('show');   
    }
    menuShow();		

...
<?php if(!$dynamic['dilogs']){
 ...
 <?php foreach($dynamic['dilogs'] as $dialog){?>    
		...
		<item id_dialod="<?php echo $dialog['id']?>" class="<?php echo ($dialog['flag'] == 's') ? 'new_message' : '' ?>">     
            <photo>
                    <div>
            ...
            <what>
                        <seller><?php echo $dialog['store']?></seller>
                                    ...
                                    if (data['error']){ 
                                        Assistant.greenBoard('<div>'+data['error']+'</div>', 'red');
                                         ...
                                         if(data['dilogs']){
                                            ...
                                            <what><seller>'+item['store']+'</seller><name>'+item['name']+'</name></what></item>';
                                                var $elemet = $(element);

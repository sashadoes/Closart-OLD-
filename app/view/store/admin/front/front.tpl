...
<content>
   ...
   <static>
                 ...
                 <board id="counter">
                     <item><?php echo $static['content']['VIEWS_TOTAL']; ?>:<dynamic_s>123,55</dynamic_s></item>
                     <item><?php echo $static['content']['VIEWS_DAILY']; ?>:<dynamic_s>55</dynamic_s></item>
                     <item><?php echo $static['content']['FOLLOWERS']; ?>:<dynamic_s>125</dynamic_s></item>
                     <item><?php echo $static['content']['FOLLOWERS_DAILY']; ?>:<dynamic_s>5</dynamic_s></item>
                 </board>
